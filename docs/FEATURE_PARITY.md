...
| --- | --- | --- |
| M1 / #35 React shell and resident authentication | Implemented; L1 browser pending CI | Opt-in `/app/`; resident v1 mutations plus `/status` compatibility diagnostics; legacy `/` remains default. |
